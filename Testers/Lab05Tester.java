...
public class Lab05Tester{
	...
	public Lab05Tester(){
		...
		do{
			input = 0;
			System.out.print("\n\nCHOOSE(-1 to exit)\n\t1.Number of vertices\n\t2.Number of edges\n\t3.Check list of adjacent vertices\n\t4.Adjacency test\n\t5.Check Connectivity\n\t6.Add Vertex\n\t7.Add Edge\n\t8.Remove vertex\n\t9.Remove Edge\n\t10.Find Critical Path\n\t11.Find Critical Path with Edge weight\n\t12.Read File\n\t13.Reset Graph\nChoice:");
			try{
				input = scan.nextInt();
			...
			switch(input){
				...
				case 9: System.out.print("Enter an edge (vertex pair separated by comma ',') to be removed: ");
						...
						graph.removeEdge(v1);
						break;
				case 10:cpr = graph.findCriticalPath(graph);
						System.out.println("Critical Path: "+cpr.getCriticalPath()+" Critical Time: "+cpr.getCriticalTime());
						break;
				case 11:cpr = graph.findLeastCriticalPath(graph);
						System.out.println("Critical Path: "+cpr.getCriticalPath()+" Critical Time: "+cpr.getCriticalTime());
						break;
				case 12:System.out.print("Make sure to include file extension. \nIF YOU ARE INSERTING ANOTHER GRAPH, YOU ARE ADVISED TO RESET FIRST! \n\tEnter file: ");
						v1 = scanText.nextLine();
						graph.readGraph(v1);
						break;
				case 13:graph = new DGraph(initSize);
