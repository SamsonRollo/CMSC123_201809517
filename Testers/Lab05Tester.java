...
public class Lab05Tester{
	...
	public Lab05Tester(){
		...
		graph = new DGraph(input);

		do{
			input = 0;
			System.out.print("\n\nCHOOSE(-1 to exit)\n\t1.Number of vertices\n\t2.Number of edges\n\t3.Check list of adjacent vertices\n\t4.Adjacency test\n\t5.Check Connectivity\n\t6.Add Vertex\n\t7.Add Vertex with Execution time\n\t8.Add Edge\n\t9.Remove vertex\n\t10.Remove Edge\n\t11.DFS\n\t12.BFS\n\t13.Topological Sort\nChoice:");
			try{
				input = scan.nextInt();
			...
			switch(input){
				...
				case 6:	System.out.println("You can enter multiple vertices. Use space for separating each vertex."); //adding vertex
						...
						graph.addVertex(v1);
						break;
				case 7:	System.out.println("You can enter multiple vertices. Use space for separating each vertex. Adding Execution time eg. A:10"); //adding vertex
						System.out.print("Enter a new name of vertex: ");
						v1 = scanText.nextLine();
						graph.addVertexWET(v1);
						break;
				case 8: System.out.println("\t-Enter vertices as follows: Vertex1,Vertex2,Weight (e.g. S,A,10)\n\t-Weight is optional\n\t-You can enter multiple edges. Use space for separating each edge."); //adding edge
						System.out.print("Enter a new edge (vertex pair): ");
						v1 = scanText.nextLine();
						graph.addEdge(v1);
						break;
				case 9: System.out.print("Enter vertex name to be removed: "); //removing vertex
						v1 = scanText.nextLine();
						graph.removeVertex(v1);
				 		break;
				case 10: System.out.print("Enter an edge (vertex pair separated by comma ',') to be removed: ");
						v1 = scanText.nextLine();
						graph.removeEdge(v1);
						break;
				case 11:System.out.print("Enter valid starting vertex: "); 
						...
						break;
				case 12:System.out.print("Enter valid starting vertex: "); 
						v1 = scanText.nextLine(); 
						graph.bfsTraversal(v1);
						break;
				case 13:graph.tSort(graph);
						break;
